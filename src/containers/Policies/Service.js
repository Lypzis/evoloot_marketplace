				...
				<div className='home__featured-section'>
					...
					<div className='home__featured home__featured--terms'>
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							This website is operated by Evoloot Marketplace.
							Throughout the site, the terms “we”, “us” and “our”
							refer to Evoloot Marketplace. Evoloot Marketplace
							offers this website, including all information,
							tools and services available from this site to you,
							the user, conditioned upon your acceptance of all
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							...
							you represent that you are at least the age of
							majority in your state or province of residence, or
							that you are the age of majority in your state or
							province of residence and you have given us your
							consent to allow any of your minor dependents to use
							this site. You may not use our products for any
							illegal or unauthorized purpose nor may you, in the
							use of the Service, violate any laws in your
							jurisdiction (including but not limited to copyright
							laws). 
						</p>
						<p className='paragraph paragraph--black small-margin-bottom'>
							You must not transmit any worms or viruses or
							any code of a destructive nature. A breach or
							violation of any of the Terms will result in an
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							...
							service to anyone for any reason at any time. You
							understand that your content (not including credit
							card information), may be transferred unencrypted
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							...
							duplicate, copy, sell, resell or exploit any portion
							of the Service, use of the Service, or access to the
							Service or any contact on the website through which
							the service is provided, without express written
							permission by us. The headings used in this
							agreement are included for convenience only and will
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							 We are not responsible if information
							made available on this site is not accurate,
							...
							Any reliance on the material on this site is at your
							own risk. This site may contain certain historical
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							...
							without notice. We reserve the right at any time to
							modify or discontinue the Service (or any part or
							content thereof) without notice at any time. We
						...
						<h4 className='heading-fourtiary heading-fourtiary--dark small-margin-bottom'>
							...
							OR SERVICES </h4>
							<p className='paragraph paragraph--black small-margin-bottom'>
							 (if applicable) Certain products or
							services may be available exclusively online through
							the website. These products or services may have
							limited quantities and are subject to return or
							exchange only according to our Return Policy. We
							have made every effort to display as accurately as
							...
							is void where prohibited. We do not warrant that the
							quality of any products, services, information, or
							other material purchased or obtained by you will
							...
							BILLING AND ACCOUNT INFORMATION</h4>
							<p className='paragraph paragraph--black small-margin-bottom'>
							 We reserve the right
							to refuse any order you place with us. We may, in
							...
							under the same customer account, the same credit
							card, and/or orders that use the same billing and/or
							shipping address. In the event that we make a change
							to or cancel an order, we may attempt to notify you
							by contacting the e‑mail and/or billing
							address/phone number provided at the time the order
							was made. We reserve the right to limit or prohibit
							orders that, in our sole judgment, appear to be
							placed by dealers, resellers or distributors. You
							...
							contact you as needed. For more detail, please
							...
							control nor input. You acknowledge and agree that we
							provide access to such tools ”as is” and “as
							available” without any warranties, representations
							or conditions of any kind and without any
							endorsement. We shall have no liability whatsoever
							arising from or relating to your use of optional
							third-party tools. Any use by you of optional tools
							offered through the site is entirely at your own
							risk and discretion and you should ensure that you
							are familiar with and approve of the terms on which
							...
							Such new features and/or services shall also be
							subject to these Terms of Service.
							</p>
							<h4 className='heading-fourtiary heading-fourtiary--dark small-margin-bottom'>
							 SECTION 8 -
							THIRD-PARTY LINKS </h4>
							<p className='paragraph paragraph--black small-margin-bottom'>
							 Certain content, products and
							services available via our Service may include
							materials from third-parties. Third-party links on
							this site may direct you to third-party websites
							that are not affiliated with us. We are not
							responsible for examining or evaluating the content
							or accuracy and we do not warrant and will not have
							any liability or responsibility for any third-party
							materials or websites, or for any other materials,
							products, or services of third-parties. We are not
							liable for any harm or damages related to the
							purchase or use of goods, services, resources,
							...
							specific submissions (for example contest entries)
							or without a request from us you send creative
							ideas, suggestions, proposals, plans, or other
							materials, whether online, by email, by postal mail,
							or otherwise (collectively, 'comments'), you agree
							...
							could in any way affect the operation of the Service
							or any related website. You may not use a false
							...
							<h4 className='heading-fourtiary heading-fourtiary--dark small-margin-bottom'>
							 ...
							 <p className='paragraph paragraph--black small-margin-bottom'>
							  Your
							submission of personal information through the store
							...
							on our site or in the Service that contains
							...
							or clarify information in the Service or on any
							...
							that your use of our service will be uninterrupted,
							timely, secure or error-free. We do not warrant that
							the results that may be obtained from the use of the
							service will be accurate or reliable. You agree that
							from time to time we may remove the service for
							indefinite periods of time or cancel the service at
							any time, without notice to you. You expressly agree
							that your use of, or inability to use, the service
							is at your sole risk. The service and all products
							and services delivered to you through the service
							...
							<p className='paragraph paragraph--black small-margin-bottom'>
							 In
							no case shall Evoloot Marketplace, our directors,
							...
							hold harmless Evoloot Marketplace and our parent,
							...
							these Terms of Service is determined to be unlawful,
							void or unenforceable, such provision shall
							nonetheless be enforceable to the fullest extent
							permitted by applicable law, and the unenforceable
							portion shall be deemed to be severed from these
							Terms of Service, such determination shall not
							affect the validity and enforceability of any other
							...
							<h4 className='heading-fourtiary heading-fourtiary--dark small-margin-bottom'>
							 ...
							 <p className='paragraph paragraph--black small-margin-bottom'>
							  The
							obligations and liabilities of the parties incurred
							...
							Services, or when you cease using our site. If in
							our sole judgment you fail, or we suspect that you
							...
							remain liable for all amounts due up to and
							including the date of termination; and/or
							...
							<h4 className='heading-fourtiary heading-fourtiary--dark small-margin-bottom'>
							 ...
							 <p className='paragraph paragraph--black small-margin-bottom'>
							  The
							failure of us to exercise or enforce any right or
							...
							versions of the Terms of Service). Any ambiguities
							in the interpretation of these Terms of Service
							...
							and any separate agreements whereby we provide you
							...
							at this page. We reserve the right, at our sole
							discretion, to update, change or replace any part of
							these Terms of Service by posting updates and
							...
							to us at&ensp;
							<a href="mailto:store@evoloot.com" title="email to store@evoloot.com"
                  			target="_blank" rel="noopener noreferrer" className="paragraph paragraph--black">store@evoloot.com</a>.
						</p>
					</div>
				</div>
			</section>
