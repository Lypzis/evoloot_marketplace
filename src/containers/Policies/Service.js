			...
			<section className='home home--terms'>
				<div className='home__featured-section'>
					...
					<div className='home__featured home__featured--terms'>
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							Our store is hosted on Shopify Inc. They provide us
							with the online e-commerce platform that allows us
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							...
							the material on this site is at your own risk. This
							site may contain certain historical information.
							Historical information, necessarily, is not current
							and is provided for your reference only. We reserve
							the right to modify the contents of this site at any
							time, but we have no obligation to update any
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							(if applicable) Certain products or services may be
							available exclusively online through the website.
							These products or services may have limited
							quantities and are subject to return or exchange
							only according to our Return Policy. We have made
							every effort to display as accurately as possible
							the colors and images of our products that appear at
							the store. We cannot guarantee that your computer
							monitor's display of any color will be accurate. We
							reserve the right, but are not obligated, to limit
							...
							services that we offer. All descriptions of products
							or product pricing are subject to change at anytime
							without notice, at the sole discretion of us. We
							reserve the right to discontinue any product at any
							time. Any offer for any product or service made on
							this site is void where prohibited. We do not
							warrant that the quality of any products, services,
							information, or other material purchased or obtained
							by you will meet your expectations, or that any
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							...
							or distributors. You agree to provide current,
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							...
							information, including your email address and credit
							card numbers and expiration dates, so that we can
							complete your transactions and contact you as
							needed. For more detail, please review our Returns
							Policy.
						</p>
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							...
							access to such tools ”as is” and “as available”
							without any warranties, representations or
							conditions of any kind and without any endorsement.
							We shall have no liability whatsoever arising from
							or relating to your use of optional third-party
							tools. Any use by you of optional tools offered
							through the site is entirely at your own risk and
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							...
							third-parties. Third-party links on this site may
							direct you to third-party websites that are not
							affiliated with us. We are not responsible for
							examining or evaluating the content or accuracy and
							we do not warrant and will not have any liability or
							responsibility for any third-party materials or
							websites, or for any other materials, products, or
							services of third-parties. We are not liable for any
							harm or damages related to the purchase or use of
							goods, services, resources, content, or any other
							transactions made in connection with any third-party
							websites. Please review carefully the third-party's
							policies and practices and make sure you understand
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							...
							secure or error-free. We do not warrant that the
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							In no case shall Evoloot Marketplace, our directors,
						...
						<p className='paragraph paragraph--black small-margin-bottom'>
							...
							Evoloot Marketplace and our parent, subsidiaries,
